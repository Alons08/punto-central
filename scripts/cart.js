...
function submitOrder() {
    ...
    let message = `¡Hola Punto Central! Quiero realizar el siguiente pedido:\n\n`;
    ...
    const whatsappUrl = `https://wa.me/51967078534?text=${encodeURIComponent(message)}`; /*AQUI EL NUMERO*/
